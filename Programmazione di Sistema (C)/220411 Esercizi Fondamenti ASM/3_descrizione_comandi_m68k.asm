...
2. move.l #$12345678,a1	;Istruzione valida, copia il numero in
						;formato esadecimale nel registro

3. move.b a3,d6 ;Istruzione valida, copia i primi 8 bit

4. swap d3,d5	;Istruzione non valida, swap ha un unico operando
				;serve per scambiare le duè metà del registro

5. add.w d2,a4	;Istruzione valida

6. add.l d2,d4,d6	;Istruzione non valida, add vuole solo due 
					;operandi
